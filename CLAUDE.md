...
| **Excel from scan** | Open a scanned PDF → Export → Excel → Automatic → Detect → OCR runs, grid appears; for handwriting use Local handwriting (offline, one-time ~80 MB model download) or Azure AI (endpoint+key in Settings → API keys) |
